INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
...
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/role/all/enabled', 'GET', '获取所有启用状态的角色', 1, '1', '2022-07-02 19:53:12', '1',
        '2022-07-03 13:02:19', 0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/user/*/all/enabled/role', 'GET', '获取指定用户拥有的所有启用状态的角色', 1, '1', '2022-07-02 20:19:50',
        '1',
        '2022-07-03 13:02:22', 0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/user/*/role', 'PUT', '给指定用户授予指定角色', 1, '1', '2022-07-02 20:53:25', '1', '2022-07-04 11:05:39',
        0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
...
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/role/*/permission', 'PUT', '给指定角色授予指定权限', 1, '1', '2022-07-03 20:35:45', '1',
        '2022-07-03 20:35:47', 0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/permission/all/enabled', 'GET', '获取所有启用状态的权限', 1, '1', '2022-07-03 20:38:57', '1',
        '2022-07-03 20:38:59',
        0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/role/*/all/enabled/permission', 'GET', '获取指定角色拥有的所有启用状态的权限', 1, '1',
        '2022-07-03 20:44:11', '1',
        '2022-07-03 20:44:12', 0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/permission/page', 'GET', '查询权限分页列表', 1, '1', '2022-07-04 10:45:53', '1', '2022-07-04 10:45:53',
        0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
...
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/permission/lock/*', 'POST', '锁定指定的权限', 1, '1', '2022-07-04 14:33:02', '1', '2022-07-04 14:33:02',
        0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/permission/unlock/*', 'POST', '解锁指定的权限', 1, '1', '2022-07-04 14:33:21', '1', '2022-07-04 14:33:21',
        0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
...
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/friend/link/page', 'GET', '查询友链分页列表', 1, '1', '2022-07-05 17:49:40', '1', '2022-07-05 17:49:40',
        0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
...
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/friend/link/refresh/cache', 'POST', '刷新友链缓存', 1, '1', '2022-07-05 19:25:22', '1',
        '2022-07-05 19:25:22',
        0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
...
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/system/config/page', 'GET', '查询系统配置分页列表', 1, '1', '2022-07-06 10:44:03', '1',
        '2022-07-06 10:44:03', 0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
...
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/admin/preview/mail/text/*', 'GET', '查看邮件内容', 1, '1', '2022-07-07 09:26:06', '1', '2022-07-07 09:26:06',
        0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/article/title/list', 'GET', '获取文章的标题列表', 1, '1', '2022-07-07 10:43:56', '1',
...
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/file/page', 'GET', '查询文件上传记录分页列表', 1, '1', '2022-07-07 16:14:13', '1', '2022-07-07 16:14:13',
        0);
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
...
INSERT INTO `t_permission` (`path`, `method`, `permission_desc`, `is_enabled`, `create_by`, `create_time`,
                            `update_by`, `update_time`, `is_deleted`)
VALUES ('/api/user/nickname', 'GET', '获取当前登录的用户昵称', 1, '1', '2022-07-11 19:19:11', '1',
