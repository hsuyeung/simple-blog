INSERT INTO `blog`.`t_system_config` (`conf_key`, `conf_value`, `conf_group`, `description`, `is_enabled`, `create_by`,
...
INSERT INTO `blog`.`t_system_config` (`conf_key`, `conf_value`, `conf_group`, `description`, `is_enabled`,
